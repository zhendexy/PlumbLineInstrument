...
public:
    ...
    void setupUi(QMainWindow *PlumbLineInstrumentClass)
    {
        ...
        PlumbLineInstrumentClass->resize(1196, 826);
        ...
        layoutWidget->setGeometry(QRect(350, 530, 311, 231));
        ...
        label_xc2 = new QLabel(layoutWidget);
        label_xc2->setObjectName(QStringLiteral("label_xc2"));

        gridLayout->addWidget(label_xc2, 6, 1, 1, 1);

        label_yc2 = new QLabel(layoutWidget);
        label_yc2->setObjectName(QStringLiteral("label_yc2"));

        gridLayout->addWidget(label_yc2, 6, 2, 1, 1);

        label_zc2 = new QLabel(layoutWidget);
        label_zc2->setObjectName(QStringLiteral("label_zc2"));

        gridLayout->addWidget(label_zc2, 6, 3, 1, 1);
    ...
    void retranslateUi(QMainWindow *PlumbLineInstrumentClass)
    {
        ...
        label_33->setText(QApplication::translate("PlumbLineInstrumentClass", "\345\260\217\347\220\2031\347\233\270\346\234\272\345\235\220\346\240\207", Q_NULLPTR));
        ...
        label_4->setText(QApplication::translate("PlumbLineInstrumentClass", "\345\260\217\347\220\2032\347\233\270\346\234\272\345\235\220\346\240\207", Q_NULLPTR));
        label_xc2->setText(QString());
        label_yc2->setText(QString());
        label_zc2->setText(QString());
